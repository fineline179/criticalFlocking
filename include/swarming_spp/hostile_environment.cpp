...
/*----------------------- Hostile class --------------------------*/
HostileEnvironment::HostileEnvironment(int nags, double L, Agent* ags, double* p, double* v, double* vN, int npreds, Agent* preds): Community(nags, L, ags, p, v, vN)
{
...
HostileEnvironment spp_hostile_autostart(int num_agents, double speed, double box_size, Behavior* agsbeh, int num_predators, Behavior* predsbeh){
    ...
    HostileEnvironment hos = HostileEnvironment(num_agents, box_size, ags, pos, vel, velNorm, num_predators, preds);
